...
final class GuideOverlayView: UIView {
    ...
    private let items: [Item] = [
        Item(symbol: "hand.tap",
             title: "Tap the top-left corner",
             detail: "Shows the controls. Tap it again to hide them. Only that corner, so taps meant for the page and for the bar's own buttons are never caught by mistake."),
        ...
        Item(symbol: "arrow.down",
             ...
             detail: "Chapters run into one another - reaching the end of one loads the next inline. Back steps to the previous chapter."),
        Item(symbol: "forward.end",
             title: "Next-chapter button",
             detail: "Jumps to the next chapter if it has not stitched itself on yet."),
